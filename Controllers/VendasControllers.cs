...
namespace TF_PP.Controllers
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="dtoList">Lista de DTOs de vendas.</param>
        ...
        /// <response code="400">Indica erro de validação nos dados da venda ou estoque insuficiente.</response>
        ...
        public IActionResult Post([FromBody] List<VendasDTO> dtoList)
        {
            try
            {
